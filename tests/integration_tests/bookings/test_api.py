...
@pytest.mark.parametrize(
    "hotel_id, room_id, date_from, date_to, status_code, unexpected_field",
    [
        (1, 1, "2025-09-01", "2025-09-10", 200, None),
        (1, 1, "2025-09-01", "2025-09-10", 200, None),
        (1, 1, "2025-09-01", "2025-09-10", 409, None),
        (1, 1, "2025-09-11", "2025-09-20", 200, None),
        (1, 1, "2025-09-11", "2025-09-20", 200, None),
        (1, 1, "2025-09-11", "2025-09-20", 409, None),
        (1, 2, "2025-09-01", "2025-09-10", 200, None),
        (1, 2, "2025-09-01", "2025-09-10", 200, None),
        (1, 2, "2025-09-01", "2025-09-10", 409, None),
        (1, 2, "2025-09-11", "2025-09-20", 200, None),
        (1, 2, "2025-09-11", "2025-09-20", 200, None),
        (1, 2, "2025-09-11", "2025-09-20", 409, None),
        (1, 2, "2025-09-21", "2025-09-30", 422, "unexpected_field"),
        (1, -1, "2025-09-21", "2025-09-30", 422, None),
        (1, 0, "2025-09-21", "2025-09-30", 422, None),
        (1, 2147483647, "2025-09-21", "2025-09-30", 422, None),
        (1, 3, "2025-09-01", "2025-09-32", 422, None),
        (1, 111, "2025-09-01", "2025-09-30", 404, None),
        (1, 222, "2025-09-01", "2025-09-30", 404, None),
        (1, 333, "2025-09-01", "2025-09-30", 404, None),
    ],
)
async def test_add_booking(
    ...
    if hotel_id is not None:
        request_json["hotel_id"] = hotel_id
...
@pytest.mark.parametrize(
    "hotel_id, room_id, date_from, date_to, case, status_code",
    [
        (1, 1, "2025-09-01", "2025-09-05", 1, 200),
        (1, 1, "2025-09-01", "2025-09-05", 2, 200),
        (1, 1, "2025-09-01", "2025-09-05", 3, 409),
        (1, 2, "2025-09-01", "2025-09-05", 3, 200),
        (1, 2, "2025-09-01", "2025-09-05", 4, 200),
        (1, 2, "2025-09-01", "2025-09-05", 5, 409),
        (2, 3, "2025-09-01", "2025-09-05", 5, 200),
        (2, 3, "2025-09-01", "2025-09-05", 6, 200),
        (2, 3, "2025-09-01", "2025-09-05", 7, 409),
    ],
)
async def test_add_and_get_my_bookings(
    case, hotel_id, room_id, date_from, date_to, status_code, delete_all_bookings, authed_ac
):
    # Add a booking
